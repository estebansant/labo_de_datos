...
carpeta = "/home/Estudiante/Documentos/clase6/medidas/"

#%% VISUALIZACION - ANALISIS ESTADISTICO - MEDIDAS DE TENDENCIA - TIPS                                       #
...
#%% Boxplot por dia (y agrupado por sexo)
...
tips['proporcion'] = (tips['tip'] / tips['total_bill'])*100
print(tips['proporcion'].head())
ax = sns.boxplot(x="day", 
                 y="proporcion", 
                 hue="sex", 
                 data=tips, 
...
ax.set_title('Propinas por factura')
ax.set_xlabel('Día de la Semana')
ax.set_ylabel('Proporcion de Propina (%)')
...
fig, ax = plt.subplots()
ax = sns.violinplot(x ="sex", y ="proporcion", data = tips,
                     palette={"Female": "orange", "Male": "skyblue" })
